Cascades primarily works via hotkeys in the format ALT+x. Press these to execute different types of downloads. You can also open the downloader and input info manually, but that's kinda annoying.
...
- You can configure various downloads folders  (ie Videos, Music, Downloads) in settings. You can also set up alternate folders for the fast-download hotkeys (below).
